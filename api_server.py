...
#Added to fix tensorflow.python.framework.errors_impl.FailedPreconditionError from here: https://github.com/tensorflow/tensorflow/issues/28287
...
@app.route('/home', methods=['POST']) #POST will get the data and perform operatins
def post_image():
    global graph
    ...
    if flask.request.method == 'POST':
        ...
        for upload in flask.request.files.getlist("file2"):
            ...
            with graph.as_default():
                ...
                for (prob) in outputs[0]:
                    r = {"label": "relatedness", "probability": float(prob)}
